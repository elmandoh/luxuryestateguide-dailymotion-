...
async def main():
    ...
    # STEP 2: Groq AI - Generate Script
    ...
    try:
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Create viral short video data for: {target.title}. JSON keys: script (30 words in English), search (1 word for pexels videos), title (with emojis), tags."}
            ],
    ...
    if token:
        ...
        print(f"❌ DM Auth Failed: {token_res}")
